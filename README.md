...
- **Rust**: [guard-core-rs](https://github.com/rennf93/guard-core-rs) (in development) with adapters for tower, axum, actix-web, rocket, plus [guard-agent-rs](https://github.com/rennf93/guard-agent-rs) for telemetry
